...
(defcustom hipchat-api-url "https://api.hipchat.com/v2" "URL for HipCat API access")

(defcustom hipchat-muc-domain "conf.hipchat.com" "Conference (MUC) domain")
...
(defun hipchat-list ()
  ...
  (interactive)
  (jabber-get-disco-items (hipchat-get-connection) hipchat-muc-domain nil))
...
(defun hipchat-join ()
  ...
  (jabber-disco-get-items
   (hipchat-get-connection) hipchat-muc-domain nil
